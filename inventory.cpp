...
string CityName[] = {"WareHouse", "Delhi", "Hyderabad", "Mumbai", "Kolkata", "Bengaluru", "Noida", "Chandigarh", "Lucknow", "Kochi", "Jaipur"};

string Chandigarh[]={"Chandigarh", "Mall Road", "PMA", "PC Hotel", "Bhagat Singh Medical College", "Pari Chowk"};

string Delhi[]={"Delhi", "I-8" ,"I-14", "F-10", "F-7", "H-12"};

string Hyderabad[]={"Hyderabad", "New Town", "Garden Town", "DHA", "Model Town", "Mall road Hyderabad"};

string Mumbai[]={"Mumbai", "Bandra Kurla Complex", "Bandra", "Juhu", "Navi Mumbai", "Chowpatty"};

int graph[V][V]={   {0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 3},   //Warehouse
					{4, 0, 0, 0, 0, 0, 0, 6, 0, 0, 2},	 //Delhi
					{0, 0, 0, 0, 9, 4, 0, 0, 0, 0, 11},	 //Hyderabad
					{0, 0, 0, 0, 1, 0, 0, 0, 16, 5, 0},	 //Mumbai
					{0, 0, 9, 1, 0, 8, 13, 0, 10, 6, 0}, //Kolkata	
					{0, 0, 4, 0, 8, 0, 0, 3, 17, 0, 7},	 //Bengaluru
					{0, 0, 0, 0, 13, 0, 0, 0, 0, 0, 7},	 //Noida
					{0, 6, 0, 0, 0, 3, 0, 0, 5, 0, 0},	 //Chandigarh
					{0, 0, 0, 16, 10, 17, 0, 5, 0, 0, 0},//Lucknow
					{0, 0, 0, 5, 6, 0, 0, 0, 0, 0, 0},	 //Kochi
					{3, 2, 11, 0, 0, 7, 7, 0, 0, 0, 0}  };//Jaipur
					
//----------------------Chandigarh--------------------------------				
int AtdGraph[V1][V1]={ 	{ 0, 4, 4, 0, 0, 0 },
						{ 4, 0, 2, 0, 0, 0 },   //mall road
						{ 4, 2, 0, 3, 2, 4 },	//PMA
						{ 0, 0, 3, 0, 0, 3 },	//PC
						{ 0, 0, 2, 0, 0, 3 },	//Bhagat Singh
						{ 0, 0, 4, 3, 3, 0 } };	//Pari
...
int LhrGraph[V1][V1]={ 	{ 0, 9, 15, 6, 0, 0 },
						...
						{ 6, 0, 8, 0, 11, 0 },
						{ 0, 0, 9, 11, 0, 0 },
						{ 0, 8, 5, 0, 0, 0 } };	//Mall road hyderabad

//----------------------Mumbai----------------------------------------
int KarGraph[V1][V1]={ 	{ 0, 6, 3, 0, 0, 1 },
						{ 6, 0, 0, 2, 0, 5 },	//Bandra Kurla Complex
						{ 3, 0, 0, 0, 3, 5 },	//Bandra
						{ 0, 2, 0, 0, 6, 4 },	//Juhu
						{ 0, 0, 3, 6, 0, 6 },	//Navi Mumbai
						{ 1, 5, 5, 4, 6, 0 } };	//Chowpatty
...
int main()
{
	shop =new Shop;
	shop->name="WareHouse";
	shop->address="Delhi University, RK Puram";
